...
app.post('/purchase/:id', async (req, res) => {
  ...
  try {
    ...
    if (book && book.quantity > 0) {
		  ...
		  const catalogResponseeed = await axios.post(`http://catalog:3002/UPDATE_FINAL`,book);
		 // book.quantity=book.quantity+1;
...
app.post('/updatePrice/:id', async (req, res) => {
  ...
  try {
    ...
    const book = catalogResponse.data;
          ...
          book.price=price;
		  const catalogResponseeedjh = await axios.post(`http://catalog:3002/UPDATE_FINAL`,book);
...
app.post('/updateQuantity/:id', async (req, res) => {
  ...
  try {
    ...
    const book = catalogResponse.data;
		  ...
		  const catalogResponseeedjhjn = await axios.post(`http://catalog:3002/UPDATE_FINAL`,book);
